...
<html lang="en-us">
    ...
    <body class="inner community hero-inner-arrows">
        <!--[if lt IE 9]>
            <div class="ieblock">
        ...
        <div class="wrapper">
            ...
            <div class="body bg-pattern">
                ...
                <div class="hero-inner hero-inner-image">
                    <div class="icon icon-news icon-png"></div>
                    <div class="row">
                        <div class="small-12 medium-push-1 medium-8 large-push-1 large-6 columns">
                            
                            <div class="hero-inner-content">
                                <h1>The developers News Room</h1>
                                <p class="larger">All the latest technology and development events across the globe.</p>
                            </div>
                        </div>
                    </div>
                </div>  
                                ...
                                <ul class="accordion news-list" data-accordion="">
                                    <li class="accordion-navigation">
                                      <a href="#faq-1" aria-expanded="false" class="accordion-link">
                                        <span class="date">Sunday - June 25, 2016</span>
                                        Summit Forests Expands Business Capabilities with Trimble's Connected Forest Technology and other cool stuff.</a>
                                      <div id="faq-1" class="content">
                                        ...
                                        <p><a href="" class="button button-yellow button-large">Read More</a></p>
                                      </div>
                                    </li>

                                    <li class="accordion-navigation">
                                      <a href="#faq-2" aria-expanded="false" class="accordion-link">
                                        <span class="date">Sunday - June 25, 2016</span>
                                        Summit Forests Expands Business Capabilities with Trimble's Connected Forest Technology and other cool stuff.</a>
                                    ...
                                    <li class="accordion-navigation">
                                      <a href="#faq-3" aria-expanded="false" class="accordion-link">
                                        <span class="date">Sunday - June 25, 2016</span>
                                        Summit Forests Expands Business Capabilities with Trimble's Connected Forest Technology and other cool stuff.</a>
