        ...
        <!--[if lt IE 9]>
            ...
            <div class="wrapper">
                ...
                <div class="body bg-pattern">
                    ...
                    <div class="hero-inner hero-inner-image hero-inner-subnav">
                        ...
                        <div class="subnav">
                            <ul class="accordion subnav-accordion" data-accordion="">
                                <li class="accordion-navigation">
                                  ...
                                  <div id="subnav" class="content">
                                    ...
                                    <a href="software-development-docs.php">Documentation</a>
                                    <a href="software-development-files.php" class="active">Design Files</a>
                                </div>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="row">
                            <div class="small-12 medium-12 medium-push-2 medium-8 large-push-3 large-9 columns">
                                ...
                                <ul class="accordion file-list" data-accordion="">
                                    <li class="accordion-navigation">
                                      <a href="#faq-1" aria-expanded="false" class="accordion-link">
                                        <div class="row">
                                            <div class="small-12 columns">
                                                <div class="icon icon-code">File</div>

                                                <div class="file-content">
                                                    <h3 class="h3-secondary">Developer Module Schematic</h3>
                                    ...
                                    <div id="faq-1" class="content file-content-detail">
                                        ...
                                        <div class="row">
                                            <div class="small-12 medium-9 columns">
                                                    ...
                                                    <form name="" class="file-download-select">
                                                        <div class="input-wrapper">
                                                        <select name="file_name" id="file_name">
                                                        <option value="" selected>Select File Platform</option>
                                                        <option value="/_files/ios.pdf">iOS</option>
                                                        </select>
                                                        <input class="button button-yellow" type="input" name="Submit" value="Download" onClick="window.open(file_name.value,'newtab'+file_name.value)">
                                                        </div>
                                                    </form>
