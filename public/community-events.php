        ...
        <div class="wrapper">
            ...
            <div class="body bg-pattern">
                ...
                <div class="hero-inner hero-inner-image">
                    <div class="icon icon-calendar icon-png"></div>
                    <div class="row">
                    ...
                    <div class="content">
                        ...
                        <div class="row">
                            <div class="small-12 medium-push-1 medium-9 columns">
                                ...
                                <ul class="accordion event-list" data-accordion="">
                                      ...
                                      <a href="#faq-1" aria-expanded="false" class="accordion-link">
                                        <div class="row">
                                            ...
                                            <div class="small-12 medium-8 columns">
                                                <div class="title">
                                                    Summit Forests Expands Business Capabilities with Trimble's Connected Forest Technology and other cool stuff
